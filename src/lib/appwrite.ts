...
export const APPWRITE_FOOD_OFFERINGS_COLLECTION_ID = process.env.NEXT_PUBLIC_APPWRITE_FOOD_OFFERINGS_COLLECTION_ID || 'YOUR_FOOD_OFFERINGS_COLLECTION_ID';
...
export const APPWRITE_DEVELOPER_MESSAGES_COLLECTION_ID = process.env.NEXT_PUBLIC_APPWRITE_DEVELOPER_MESSAGES_COLLECTION_ID || 'YOUR_DEVELOPER_MESSAGES_COLLECTION_ID'; // Added
export const APPWRITE_FOOD_ORDERS_COLLECTION_ID = process.env.NEXT_PUBLIC_APPWRITE_FOOD_ORDERS_COLLECTION_ID || 'YOUR_FOOD_ORDERS_COLLECTION_ID'; // Added
export const APPWRITE_TRANSACTIONS_COLLECTION_ID = process.env.NEXT_PUBLIC_APPWRITE_TRANSACTIONS_COLLECTION_ID || 'YOUR_TRANSACTIONS_COLLECTION_ID'; // Added
export const APPWRITE_BARGAIN_REQUESTS_COLLECTION_ID = process.env.NEXT_PUBLIC_APPWRITE_BARGAIN_REQUESTS_COLLECTION_ID || 'YOUR_BARGAIN_REQUESTS_COLLECTION_ID'; // Added
...
export const APPWRITE_SERVICES_COLLECTION_ID = process.env.NEXT_PUBLIC_APPWRITE_SERVICES_COLLECTION_ID || 'YOUR_SERVICES_COLLECTION_ID'; // Added
...
export const APPWRITE_BLOCKED_WORDS_COLLECTION_ID = process.env.NEXT_PUBLIC_APPWRITE_BLOCKED_WORDS_COLLECTION_ID || 'YOUR_BLOCKED_WORDS_COLLECTION_ID'; // Added
